...
resource "aws_iam_role_policy_attachment" "codepipeline_policy" {
  ...
  policy_arn = "arn:aws:iam::aws:policy/AdministratorAccess" # Temporary for testing
}
...
# Full CodeBuild access (includes build + S3 access)
resource "aws_iam_role_policy_attachment" "codebuild_access" {
  role       = aws_iam_role.codebuild_role.name
  policy_arn = "arn:aws:iam::aws:policy/AWSCodeBuildDeveloperAccess"
}

# Custom logging policy for CloudWatch Logs
